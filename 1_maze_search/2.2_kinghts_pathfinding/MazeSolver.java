...
public class MazeSolver {
	public static void main(String[] args) {
		String mazeFile = "knight.txt";
		String solnFile = "knightSolution.txt";
		...
		//boolean searchResult = st.Astar(rm,st.root,pq);
		...
		try {
			...
			pw.println("Path cost: "+(int)st.goal.cost);
			pw.println("Number of Nodes Expanded: "+st.size);
			pw.println("Maximum tree Depth searched: "+st.maxDepth(st.root));
			pw.println("Maximum size of the frontier: "+st.frontierMaxSize);
			
			System.out.println("Path cost: "+(int)st.goal.cost);
			System.out.println("Number of Nodes Expanded: "+st.size);
			System.out.println("Maximum tree Depth searched: "+st.maxDepth(st.root));
